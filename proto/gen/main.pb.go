...
import (
	...
	farewell "gRPCApi/golang/proto/gen/farewell"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
)
...
const file_main_proto_rawDesc = "" +
	...
	"\aGreeter\x12<\n" +
	"\x05Greet\x12\x18.calculator.HelloRequest\x1a\x19.calculator.HelloResponse2P\n" +
	"\vBidFarewell\x12A\n" +
	"\n" +
...
var file_main_proto_depIdxs = []int32{
	...
	3, // 2: calculator.BidFarewell.BidGoodBye:input_type -> farewell.GoodByeRequest
	1, // 3: calculator.Calculator.Add:output_type -> calculator.AddResponse
	4, // 4: calculator.Greeter.Greet:output_type -> calculator.HelloResponse
	5, // 5: calculator.BidFarewell.BidGoodBye:output_type -> farewell.GoodByeResponse
