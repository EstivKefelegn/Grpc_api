...
var file_greeter_proto_depIdxs = []int32{
	0, // 0: calculator.AuefWiedersehen.BidGoodBye:input_type -> calculator.GoodByeRequest
	1, // 1: calculator.AuefWiedersehen.BidGoodBye:output_type -> calculator.GoodByeResponse
